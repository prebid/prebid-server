...
type StageExecutor interface {
	...
	ExecuteProcessedAuctionStage(req *openrtb_ext.RequestWrapper, userSync util.IdFetcher) error
...
func (e *hookExecutor) ExecuteProcessedAuctionStage(request *openrtb_ext.RequestWrapper, userSync util.IdFetcher) error {
...
func (executor EmptyHookExecutor) ExecuteProcessedAuctionStage(_ *openrtb_ext.RequestWrapper, _ util.IdFetcher) error {
	return nil
}
