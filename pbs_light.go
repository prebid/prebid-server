...
func init() {
	...
	// Some defaults will be set just so they are accessable via environment variables
	...
	viper.SetDefault("status_response", "")
	viper.SetDefault("auction_timeouts_ms.default", 0)
	viper.SetDefault("auction_timeouts_ms.max", 0)
	viper.SetDefault("cache.scheme", "")
	viper.SetDefault("cache.host", "")
	viper.SetDefault("cache.query", "")
	viper.SetDefault("cache.expected_millis", 10)
	viper.SetDefault("recaptcha_secret", "")
	viper.SetDefault("host_cookie.domain", "")
	viper.SetDefault("host_cookie.family", "")
	viper.SetDefault("host_cookie.cookie_name", "")
	viper.SetDefault("host_cookie.opt_out_url", "")
	viper.SetDefault("host_cookie.opt_in_url", "")
	viper.SetDefault("host_cookie.optout_cookie.name", "")
	viper.SetDefault("host_cookie.value", "")
	viper.SetDefault("host_cookie.ttl_days", 90)
	// no metrics configured by default (metrics{host|database|username|password})
	viper.SetDefault("metrics.influxdb.host", "")
	viper.SetDefault("metrics.influxdb.database", "")
	viper.SetDefault("metrics.influxdb.username", "")
	viper.SetDefault("metrics.influxdb.password", "")
	viper.SetDefault("datacache.type", "dummy")
	viper.SetDefault("datacache.filename", "")
	viper.SetDefault("datacache.cache_size", 0)
	viper.SetDefault("datacache.ttl_seconds", 0)
	viper.SetDefault("stored_requests.filesystem", false)
	viper.SetDefault("stored_requests.postgres.connection.dbname", "")
	viper.SetDefault("stored_requests.postgres.connection.host", "")
	viper.SetDefault("stored_requests.postgres.connection.port", 0)
	viper.SetDefault("stored_requests.postgres.connection.user", "")
	viper.SetDefault("stored_requests.postgres.connection.password", "")
	viper.SetDefault("stored_requests.postgres.fetcher.query", "")
	viper.SetDefault("stored_requests.postgres.fetcher.amp_query", "")
	viper.SetDefault("stored_requests.postgres.initialize_caches.timeout_ms", 0)
	viper.SetDefault("stored_requests.postgres.initialize_caches.query", "")
	viper.SetDefault("stored_requests.postgres.initialize_caches.amp_query", "")
	viper.SetDefault("stored_requests.http.endpoint", "")
	viper.SetDefault("stored_requests.http.amp_endpoint", "")
	viper.SetDefault("stored_requests.in_memory_cache.ttl_seconds", 0)
	viper.SetDefault("stored_requests.in_memory_cache.request_cache_size_bytes", 0)
	viper.SetDefault("stored_requests.in_memory_cache.imp_cache_size_bytes", 0)
	viper.SetDefault("stored_requests.cache_events_api", false)
	viper.SetDefault("stored_requests.http_events.endpoint", "")
	viper.SetDefault("stored_requests.http_events.amp_endpoint", "")
	viper.SetDefault("stored_requests.http_events.refresh_rate_seconds", 0)
	viper.SetDefault("stored_requests.http_events.timeout_ms", 0)
	...
	viper.SetDefault("analytics.file.filename", "")
	viper.SetDefault("amp_timeout_adjustment_ms", 0)
	viper.SetDefault("gdpr.host_vendor_id", 0)
	viper.SetDefault("gdpr.usersync_if_ambiguous", false)
	viper.SetDefault("gdpr.timeouts_ms.init_vendorlist_fetches", 0)
	viper.SetDefault("gdpr.timeouts_ms.active_vendorlist_fetch", 0)
