...
type MetricsEngine interface {
	...
	RecordAdapterBidsReceived(labels metricsdef.AdapterLabels, bids int64)
	...
	RecordAdapterBidAdm(labels metricsdef.AdapterLabels, bidType openrtb_ext.BidType, hasAdm bool)
...
func (me *MultiMetricsEngine) RecordAdapterBidsReceived(labels metricsdef.AdapterLabels, bids int64) {
	for _, thisME := range *me {
...
func (me *MultiMetricsEngine) RecordAdapterBidAdm(labels metricsdef.AdapterLabels, bidType openrtb_ext.BidType, hasAdm bool) {
	for _, thisME := range *me {
...
func (me *DummyMetricsEngine) RecordAdapterBidsReceived(labels metricsdef.AdapterLabels, bids int64) {
	return
}

// RecordAdapterBidAdm as a noop
func (me *DummyMetricsEngine) RecordAdapterBidAdm(labels metricsdef.AdapterLabels, bidType openrtb_ext.BidType, hasAdm bool) {
	return
}
