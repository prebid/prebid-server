...
endpoints = [
  ...
  Endpoint.new('../../responses/mintegral/fill_low_bid.json', 'POST', '/mintegral_givemeads'),
  Endpoint.new('../../responses/appier/fill_low_bid.json', 'POST', '/appier_givemeads'),
  Endpoint.new('../../responses/personaly/fill_high_bid.json', 'POST', '/personaly_givemeads'),
]
