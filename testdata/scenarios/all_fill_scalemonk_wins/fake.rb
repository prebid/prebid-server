...
endpoints = [
  ...
  Endpoint.new('../../responses/operaads/fill_low_bid.json', 'POST', '/operaads_givemeads'),
  Endpoint.new('../../responses/spotad/fill_low_bid.json', 'POST', '/spotad_givemeads'),
  Endpoint.new('../../responses/scalemonk/fill_high_bid.json', 'POST', '/scalemonk_givemeads'),
  Endpoint.new('../../responses/youappi/fill_low_bid.json', 'POST', '/youappi_givemeads'),
]
