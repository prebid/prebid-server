...
func TestCreateCacheRuleSet(t *testing.T) {
	testCases := []struct {
		name            string
		in              *config.RuleSet
		expectedRuleSet cacheRuleSet[hs.ProcessedAuctionRequestPayload, hs.HookResult[hs.ProcessedAuctionRequestPayload]]
		expectedErr     error
	}{
		{
			name:            "nil-ruleset-config",
		...
		},
		{
			...
			expectedRuleSet: cacheRuleSet[hs.ProcessedAuctionRequestPayload, hs.HookResult[hs.ProcessedAuctionRequestPayload]]{modelGroups: []cacheModelGroup[hs.ProcessedAuctionRequestPayload, hs.HookResult[hs.ProcessedAuctionRequestPayload]]{}},
			expectedErr:     nil,
		},
		{
		...
		},
		{
			...
			expectedRuleSet: cacheRuleSet[hs.ProcessedAuctionRequestPayload, hs.HookResult[hs.ProcessedAuctionRequestPayload]]{
				modelGroups: []cacheModelGroup[hs.ProcessedAuctionRequestPayload, hs.HookResult[hs.ProcessedAuctionRequestPayload]]{
					{
						tree: rules.Tree[hs.ProcessedAuctionRequestPayload, hs.HookResult[hs.ProcessedAuctionRequestPayload]]{
							Root: &rules.Node[hs.ProcessedAuctionRequestPayload, hs.HookResult[hs.ProcessedAuctionRequestPayload]]{},
							DefaultFunctions: []rules.ResultFunction[hs.ProcessedAuctionRequestPayload, hs.HookResult[hs.ProcessedAuctionRequestPayload]]{
								&ExcludeBidders{
