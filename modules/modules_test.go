...
func (h module) HandleAuctionResponseHook(ctx context.Context, i hookstage.InvocationContext, response hookstage.AuctionResponsePayload) (hookstage.HookResult[hookstage.AuctionResponsePayload], error) {
