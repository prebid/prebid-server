...
func impModule(endpoint string, client *http.Client, mtr metrics.Metrics) *Module {
	return &Module{
...
func TestImpression_DefaultCurrencyWhenAbsent(t *testing.T) {
	...
	_, err := m.HandleAuctionResponseHook(t.Context(), miCtxWithFlow(flowContext{}),
