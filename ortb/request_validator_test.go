			...
			[]testCase{
				{
					...
					impExt:         nil,
					expectedImpExt: "",
					expectedErrs:   []error{&errortypes.BadInput{Message: "request.imp[0].ext is required"}},
				},
			},
		},
		{
			...
			[]testCase{
				{
					...
					expectedErrs:   []error{&errortypes.BadInput{Message: "request.imp[0].ext.prebid.bidder must contain at least one bidder"}},
				},
				{
					...
					expectedErrs: []error{&errortypes.Warning{Message: ("request.imp[0].ext contains unknown bidder: 'unknownbidder', ignoring")},
						&errortypes.BadInput{Message: "request.imp[0].ext.prebid.bidder must contain at least one bidder"}},
				},
				{
					description:    "Unknown Prebid Ext Bidder only",
					impExt:         json.RawMessage(`{"prebid":{"bidder":{"unknownbidder":{"placement_id":555}}}}`),
					expectedImpExt: `{"prebid":{"bidder":{"unknownbidder":{"placement_id":555}}}}`,
					expectedErrs:   []error{&errortypes.BadInput{Message: "request.imp[0].ext.prebid.bidder contains unknown bidder: unknownbidder. Did you forget an alias in request.ext.prebid.aliases?"}},
				},
				{
			...
			[]testCase{
				{
					...
					expectedErrs:        []error{&errortypes.BadInput{Message: "request.imp[0].ext.prebid.bidder.appnexus failed validation.\nparams error"}},
				},
				{
