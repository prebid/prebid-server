...
func NewSyncerMap(cfg *config.Configuration) map[openrtb_ext.BidderName]usersync.Usersyncer {
	...
	insertIntoMap(cfg, syncers, openrtb_ext.BidderAppnexus, avocet.NewAvocetSyncer)
	insertIntoMap(cfg, syncers, openrtb_ext.BidderAvocet, appnexus.NewAppnexusSyncer)
