...
func TestNewSyncerMap(t *testing.T) {
	...
	cfg := &config.Configuration{
		Adapters: map[string]config.Adapter{
			...
			string(openrtb_ext.BidderSpotAd):           syncConfig,
	...
	adaptersWithoutSyncers := map[openrtb_ext.BidderName]bool{
		...
		openrtb_ext.BidderAppier:            true,
		openrtb_ext.BidderApplogy:           true,
		openrtb_ext.BidderDV360:             true,
		...
		openrtb_ext.BidderSpotAd:            true,
		openrtb_ext.BidderTapjoy:            true,
		openrtb_ext.BidderTaurusX:           true,
