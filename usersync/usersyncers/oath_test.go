...
func TestOathSyncer(t *testing.T) {
	...
	assertStringsMatch(t, "http://east-bid.ybp.yahoo.com/sync/appnexuspbs?url=localhost%2Fsetuid%3Fbidder%3Doath%26gdpr%3D%26gdpr_consent%3D%26uid%3D%24%7BUID%7D", syncInfo.URL)
