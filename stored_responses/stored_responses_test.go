...
func TestProcessStoredAuctionAndBidResponsesErrors(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedErrorList: []error{errors.New("request.imp[impId: imp-id1].ext.prebid.bidder.testBidder123 is unknown. Did you forget an alias in request.ext.prebid.aliases?")},
		},
		{
