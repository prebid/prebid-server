...
func TestMultiCurrencies(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedBadCurrencyErrors: []error{
				errortypes.NewNoConversionRateError("JPY", "USD"),
			},
		...
		},
		{
			...
			expectedBadCurrencyErrors: []error{
				errortypes.NewNoConversionRateError("JPY", "USD"),
				errortypes.NewNoConversionRateError("BZD", "USD"),
				errortypes.NewNoConversionRateError("DKK", "USD"),
			},
...
func TestMultiCurrencies_RateConverterNotSet(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedBidsCount: 0,
			expectedBadCurrencyErrors: []error{
				errortypes.NewNoConversionRateError("EUR", "USD"),
				errortypes.NewNoConversionRateError("EUR", "USD"),
				errortypes.NewNoConversionRateError("EUR", "USD"),
			},
		...
		},
		{
			...
			expectedBidsCount: 2,
			expectedBadCurrencyErrors: []error{
				errortypes.NewNoConversionRateError("GBP", "USD"),
			},
