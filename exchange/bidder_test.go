...
func TestMultiCurrencies(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedBadCurrencyErrors: []error{
				currency.ConversionRateNotFoundError{FromCur: "JPY", ToCur: "USD"},
			},
		...
		},
		{
			...
			expectedBadCurrencyErrors: []error{
				currency.ConversionRateNotFoundError{FromCur: "JPY", ToCur: "USD"},
				currency.ConversionRateNotFoundError{FromCur: "BZD", ToCur: "USD"},
				currency.ConversionRateNotFoundError{FromCur: "DKK", ToCur: "USD"},
			},
...
func TestMultiCurrencies_RateConverterNotSet(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedBidsCount: 0,
			expectedBadCurrencyErrors: []error{
				currency.ConversionRateNotFoundError{FromCur: "EUR", ToCur: "USD"},
				currency.ConversionRateNotFoundError{FromCur: "EUR", ToCur: "USD"},
				currency.ConversionRateNotFoundError{FromCur: "EUR", ToCur: "USD"},
			},
		...
		},
		{
			...
			expectedBidsCount: 2,
			expectedBadCurrencyErrors: []error{
				currency.ConversionRateNotFoundError{FromCur: "GBP", ToCur: "USD"},
			},
