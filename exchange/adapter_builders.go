...
import (
	...
	"github.com/prebid/prebid-server/adapters/spotad"
...
func newAdapterBuilders() map[openrtb_ext.BidderName]adapters.Builder {
	return map[openrtb_ext.BidderName]adapters.Builder{
		...
		openrtb_ext.BidderAarki:             aarki.Builder,
		...
		openrtb_ext.BidderAppier:            appier.Builder,
		...
		openrtb_ext.BidderDV360:             dv360.Builder,
		...
		openrtb_ext.BidderPersonaly:         personaly.Builder,
		...
		openrtb_ext.BidderSpotAd:            spotad.Builder,
