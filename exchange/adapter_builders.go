...
import (
	...
	"github.com/prebid/prebid-server/adapters/diaRubiconNative"
	...
	"github.com/prebid/prebid-server/adapters/rubiconNative10"
...
func newAdapterBuilders() map[openrtb_ext.BidderName]adapters.Builder {
	return map[openrtb_ext.BidderName]adapters.Builder{
		...
		openrtb_ext.BidderDiaRubiconNative:  diaRubiconNative.Builder,
		...
		openrtb_ext.BidderRubiconNative10:   rubiconNative10.Builder,
