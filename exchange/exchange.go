...
type Exchange interface {
	...
	HoldAuction(ctx context.Context, r AuctionRequest, debugLog *DebugLog, account *config.Account) (*openrtb2.BidResponse, error)
}
...
func (e *exchange) HoldAuction(ctx context.Context, r AuctionRequest, debugLog *DebugLog, account *config.Account) (*openrtb2.BidResponse, error) {
	var err error
