...
func newAdapterMap(client *http.Client, cfg *config.Configuration, infos adapters.BidderInfos, me pbsmetrics.MetricsEngine) map[openrtb_ext.BidderName]adaptedBidder {
	ortbBidders := map[openrtb_ext.BidderName]adapters.Bidder{
		...
		openrtb_ext.BidderCrossInstall: crossinstall.NewCrossInstallBidder(
			client,
		...
		openrtb_ext.BidderMolocoCloud: molococloud.NewMolocoCloudBidder(
			client,
		...
		openrtb_ext.BidderPangle:          pangle.NewPangleBidder(client, cfg.Adapters[string(openrtb_ext.BidderPangle)].Endpoint),
		...
		openrtb_ext.BidderTaurusX: taurusx.NewTaurusXBidder(
			client,
		...
		openrtb_ext.BidderUnicorn: unicorn.NewUnicornBidder(
			client,
