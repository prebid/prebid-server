...
func TestNewExchange(t *testing.T) {
	...
	e := NewExchange(server.Client(), nil, cfg, pbsmetrics.NewMetrics(metrics.NewRegistry(), knownAdapters), adapters.ParseBidderInfos("../static/bidder-info", openrtb_ext.BidderList()), gdpr.AlwaysAllow{}, currencies.NewRateConverterDefault(), "http://www.pbcserver.com/pbcache/endpoint").(*exchange)
...
func TestCharacterEscape(t *testing.T) {
	...
	e := NewExchange(server.Client(), nil, cfg, pbsmetrics.NewMetrics(metrics.NewRegistry(), openrtb_ext.BidderList()), adapters.ParseBidderInfos("../static/bidder-info", openrtb_ext.BidderList()), gdpr.AlwaysAllow{}, currencies.NewRateConverterDefault(), "http://www.pbcserver.com/pbcache/endpoint").(*exchange)
...
func TestRaceIntegration(t *testing.T) {
	...
	ex := NewExchange(server.Client(), &wellBehavedCache{}, cfg, theMetrics, adapters.ParseBidderInfos("../static/bidder-info", openrtb_ext.BidderList()), gdpr.AlwaysAllow{}, currencies.NewRateConverterDefault(), "http://www.pbcserver.com/pbcache/endpoint")
...
func TestPanicRecovery(t *testing.T) {
	...
	theMetrics := pbsmetrics.NewMetrics(metrics.NewRegistry(), openrtb_ext.BidderList())
	e := NewExchange(&http.Client{}, nil, cfg, theMetrics, adapters.ParseBidderInfos("../static/bidder-info", openrtb_ext.BidderList()), gdpr.AlwaysAllow{}, currencies.NewRateConverterDefault(), "http://www.pbcserver.com/pbcache/endpoint").(*exchange)
