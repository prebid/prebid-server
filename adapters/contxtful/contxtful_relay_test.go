...
func TestContxtfulRelay(t *testing.T) {
	...
	bidder, buildErr := Builder(openrtb_ext.BidderContxtful, config.Adapter{
		Endpoint:         "https://prebid.receptivity.io/v1/prebid/{{.AccountID}}/bid",  // Use the dynamic endpoint template
		ExtraAdapterInfo: `{"monitoringEndpoint": "https://monitoring.receptivity.io"}`, // Add monitoring endpoint for tests
	}, config.Server{})
	...
	expectedEndpoint := "https://prebid.receptivity.io/v1/prebid/test-customer-123/bid"
