...
// Builder builds a new instance of the omnidex for the given bidder with the given config.
...
func extractCid(imp *openrtb2.Imp) (string, error) {
	...
	var impExt openrtb_ext.ImpExtOmnidex
	if err := jsonutil.Unmarshal(bidderExt.Bidder, &impExt); err != nil {
		return "", fmt.Errorf("unmarshal ImpExtOmnidex: %w", err)
	}
