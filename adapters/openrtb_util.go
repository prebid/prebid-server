...
func makeOpenRTBGeneric(req *pbs.PBSRequest, bidder *pbs.PBSBidder, bidderFamily constants.FamilyName) openrtb.BidRequest {
	...
	return openrtb.BidRequest{
		...
		User: &openrtb.User{
			...
			ID:       req.GetUserID(constants.FNAppnexus),
		},
		Source: &openrtb.Source{
