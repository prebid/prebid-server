...
func TestJsonSamples(t *testing.T) {
	bidder, buildErr := Builder(openrtb_ext.BidderDmx, config.Adapter{}, config.Server{ExternalUrl: "http://hosturl.com", GdprID: 1, Datacenter: "2"})
...
func TestMakeRequestsOtherPlacement(t *testing.T) {
	...
	bidder, buildErr := Builder(openrtb_ext.BidderDmx, config.Adapter{
		Endpoint: "https://dmx.districtm.io/b/v2"}, config.Server{ExternalUrl: "http://hosturl.com", GdprID: 1, Datacenter: "2"})
