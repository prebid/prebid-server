...
func TestValidParams(t *testing.T) {
	...
	for _, validParam := range validParams {
		if err := validator.Validate(openrtb_ext.BidderSonobi, openrtb.RawJSON(validParam)); err != nil {
...
func TestInvalidParams(t *testing.T) {
	...
	for _, invalidParam := range invalidParams {
		if err := validator.Validate(openrtb_ext.BidderSonobi, openrtb.RawJSON(invalidParam)); err == nil {
