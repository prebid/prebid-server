...
func VerifyStringValue(value string, expected string, t *testing.T) {
	if value != expected {
		t.Fatal(fmt.Sprintf("%s expected, got %s", expected, value))
	}
}
...
func VerifyIntValue(value int, expected int, t *testing.T) {
	if value != expected {
		t.Fatal(fmt.Sprintf("%d expected, got %d", expected, value))
	}
}
...
func VerifyBoolValue(value bool, expected bool, t *testing.T) {
	if value != expected {
		t.Fatal(fmt.Sprintf("%v expected, got %v", expected, value))
	}
}
