...
func NewSetUIDEndpoint(cfg config.HostCookie, perms gdpr.Permissions, validFamilyNameMap map[string]struct{}, pbsanalytics analytics.PBSAnalyticsModule, metrics pbsmetrics.MetricsEngine) httprouter.Handle {
