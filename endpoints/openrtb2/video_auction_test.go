...
func (m *mockExchangeVideo) HoldAuction(ctx context.Context, r exchange.AuctionRequest, debugLog *exchange.DebugLog) (*openrtb_ext.ResponseWrapper, error) {
	...
	return &openrtb_ext.ResponseWrapper{BidResponse: &openrtb2.BidResponse{
		SeatBid: []openrtb2.SeatBid{{
			Seat: "appnexus",
			Bid: []openrtb2.Bid{
...
func (m *mockExchangeAppendBidderNames) HoldAuction(ctx context.Context, r exchange.AuctionRequest, debugLog *exchange.DebugLog) (*openrtb_ext.ResponseWrapper, error) {
	m.lastRequest = r.BidRequestWrapper.BidRequest
	if debugLog != nil && debugLog.Enabled {
		m.cache.called = true
	}
...
func (m *mockExchangeVideoNoBids) HoldAuction(ctx context.Context, r exchange.AuctionRequest, debugLog *exchange.DebugLog) (*openrtb_ext.ResponseWrapper, error) {
	m.lastRequest = r.BidRequestWrapper.BidRequest
	return &openrtb_ext.ResponseWrapper{BidResponse: &openrtb2.BidResponse{
		SeatBid: []openrtb2.SeatBid{{}},
	}}, nil
