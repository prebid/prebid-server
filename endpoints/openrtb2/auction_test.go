...
func TestWorkaroundIOS14PrivacyBug(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			description: "iOS <14.0 - Unchanged",
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "13.1", Lmt: nil},
			},
			expectedLMT: nil,
		},
		{
			description: "iOS 14.0 - Empty IFA",
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
		...
		{
			description: "iOS 14.0 - Zero IFA",
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "14.0", IFA: "00000000-0000-0000-0000-000000000000", Lmt: nil},
			},
			expectedLMT: &lmtOne,
		},
		{
			description: "iOS 14.0 - Populated IFA",
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "14.0", IFA: "any-real-value", Lmt: nil},
			},
			expectedLMT: &lmtZero,
		},
		{
			description: "iOS 14.0 - Overwrites Existing LMT Value",
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "14.0", IFA: "any-real-value", Lmt: &lmtOne},
			},
			expectedLMT: &lmtZero,
		},
		{
			description: "iOS 14.1 - Empty IFA",
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "14.1", IFA: "", Lmt: nil},
			},
			expectedLMT: &lmtOne,
		},
		{
			description: "iOS 14.1 - Zero IFA",
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "14.1", IFA: "00000000-0000-0000-0000-000000000000", Lmt: nil},
			},
			expectedLMT: &lmtOne,
		},
		{
			description: "iOS 14.1 - Populated IFA",
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "14.1", IFA: "any-real-value", Lmt: nil},
			},
			expectedLMT: &lmtZero,
		},
		{
			description: "iOS 14.1 - Overwrites Existing LMT Value",
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "14.1", IFA: "any-real-value", Lmt: &lmtOne},
			},
			expectedLMT: &lmtZero,
		},
		{
			description: "iOS 14.2 - Status - Not Determined",
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "14.2", Ext: json.RawMessage(`{"atts":0}`), Lmt: nil},
			},
			expectedLMT: &lmtZero,
		},
		{
			description: "iOS 14.2 - Status - Restricted",
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "14.2", Ext: json.RawMessage(`{"atts":1}`), Lmt: nil},
			},
			expectedLMT: &lmtOne,
		},
		{
			description: "iOS 14.2 - Status - Denied",
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "14.2", Ext: json.RawMessage(`{"atts":2}`), Lmt: nil},
			},
			expectedLMT: &lmtOne,
		},
		{
			description: "iOS 14.2 - Status - Authorized",
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "14.2", Ext: json.RawMessage(`{"atts":3}`), Lmt: nil},
			},
			expectedLMT: &lmtZero,
		},
		{
			description: "iOS 14.2 - Overwrites Existing LMT Value",
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "14.2", Ext: json.RawMessage(`{"atts":3}`), Lmt: &lmtOne},
			},
			expectedLMT: &lmtZero,
		},
		{
			...
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "14.3", Ext: json.RawMessage(`{"atts":0}`), Lmt: nil},
			},
			expectedLMT: &lmtZero,
		},
		{
			...
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "14.3", Ext: json.RawMessage(`{"atts":1}`), Lmt: nil},
			},
			expectedLMT: &lmtOne,
		},
		{
			...
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "14.3", Ext: json.RawMessage(`{"atts":2}`), Lmt: nil},
			},
			expectedLMT: &lmtOne,
		},
		{
			...
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "14.3", Ext: json.RawMessage(`{"atts":3}`), Lmt: nil},
			},
			expectedLMT: &lmtZero,
		},
		{
			...
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "14.3", Ext: json.RawMessage(`{"atts":3}`), Lmt: &lmtOne},
			},
			expectedLMT: &lmtZero,
		},
		{
			description: "iOS Case Insensitive",
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "ios", OSV: "14.0", IFA: "", Lmt: nil},
			},
		...
		{
			description: "Unchanged - iOS Version Empty",
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", Lmt: nil},
			},
			expectedLMT: nil,
		},
		{
			description: "Unchanged - iOS Version Invalid",
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "iOS", OSV: "14.3", Lmt: nil},
			},
			expectedLMT: nil,
		},
		{
			description: "Unchanged - Missing App",
			givenRequest: &openrtb.BidRequest{
				App:    nil,
				Device: &openrtb.Device{OS: "iOS", OSV: "14.2", Ext: json.RawMessage(`{"atts":3}`), Lmt: nil},
			},
		...
		{
			description: "Unchanged - Not iOS",
			givenRequest: &openrtb.BidRequest{
				App:    &openrtb.App{},
				Device: &openrtb.Device{OS: "not-ios", OSV: "14.2", Ext: json.RawMessage(`{"atts":3}`), Lmt: nil},
			},
			expectedLMT: nil,
		},
	}
	...
	for _, test := range testCases {
		workaroundIOS14PrivacyBug(test.givenRequest)
