...
func TestParseGzipedRequest(t *testing.T) {
	testCases :=
		[]struct {
		...
		}{
			{
				...
				reqContentEnc:  "gzip",
				maxReqSize:     10,
				compressionCfg: config.Compression{Request: config.ReqCompression{Enabled: true, Kind: []string{"gzip"}}},
	...
	deps := &endpointDeps{
		...
		empty_fetcher.EmptyFetcher{},
		empty_fetcher.EmptyFetcher{},
		&config.Configuration{MaxRequestSize: int64(50), Compression: config.Compression{Request: config.ReqCompression{Enabled: false, Kind: []string{}}}},
		&metricsConfig.NilMetricsEngine{},
		analyticsConf.NewPBSAnalytics(&config.Analytics{}),
		map[string]string{},
		false,
