...
func (e *warningsCheckExchange) HoldAuction(ctx context.Context, r exchange.AuctionRequest, debugLog *exchange.DebugLog, account *config.Account) (*openrtb2.BidResponse, error) {
	e.auctionRequest = r
	return nil, nil
}
...
func (e *nobidExchange) HoldAuction(ctx context.Context, r exchange.AuctionRequest, debugLog *exchange.DebugLog, account *config.Account) (*openrtb2.BidResponse, error) {
...
func (e *mockBidExchange) HoldAuction(ctx context.Context, r exchange.AuctionRequest, debugLog *exchange.DebugLog, account *config.Account) (*openrtb2.BidResponse, error) {
...
func (e *brokenExchange) HoldAuction(ctx context.Context, r exchange.AuctionRequest, debugLog *exchange.DebugLog, account *config.Account) (*openrtb2.BidResponse, error) {
...
func (m *mockExchange) HoldAuction(ctx context.Context, r exchange.AuctionRequest, debugLog *exchange.DebugLog, account *config.Account) (*openrtb2.BidResponse, error) {
