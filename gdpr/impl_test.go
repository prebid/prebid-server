...
func allPurposesEnabledTCF2Config() (TCF2AggConfig tcf2Config) {
	TCF2AggConfig = tcf2Config{
		HostConfig: config.TCF2{
			Enabled:         true,
			Purpose1:        config.TCF2Purpose{EnforceAlgo: TCF2FullEnforcement, EnforcePurpose: true, EnforceVendors: true},
			Purpose2:        config.TCF2Purpose{EnforceAlgo: TCF2FullEnforcement, EnforcePurpose: true, EnforceVendors: true},
			Purpose3:        config.TCF2Purpose{EnforceAlgo: TCF2FullEnforcement, EnforcePurpose: true, EnforceVendors: true},
			Purpose4:        config.TCF2Purpose{EnforceAlgo: TCF2FullEnforcement, EnforcePurpose: true, EnforceVendors: true},
			Purpose5:        config.TCF2Purpose{EnforceAlgo: TCF2FullEnforcement, EnforcePurpose: true, EnforceVendors: true},
			Purpose6:        config.TCF2Purpose{EnforceAlgo: TCF2FullEnforcement, EnforcePurpose: true, EnforceVendors: true},
			Purpose7:        config.TCF2Purpose{EnforceAlgo: TCF2FullEnforcement, EnforcePurpose: true, EnforceVendors: true},
			Purpose8:        config.TCF2Purpose{EnforceAlgo: TCF2FullEnforcement, EnforcePurpose: true, EnforceVendors: true},
			Purpose9:        config.TCF2Purpose{EnforceAlgo: TCF2FullEnforcement, EnforcePurpose: true, EnforceVendors: true},
			Purpose10:       config.TCF2Purpose{EnforceAlgo: TCF2FullEnforcement, EnforcePurpose: true, EnforceVendors: true},
