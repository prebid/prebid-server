...
func TestFullConfig(t *testing.T) {
	...
	cmpStrings(t, "adapters.oath.endpoint", cfg.Adapters["oath"].Endpoint, "http://east-bid.ybp.yahoo.com/bid/appnexuspbs")
	cmpStrings(t, "adapters.oath.usersync_url", cfg.Adapters["oath"].UserSyncURL, "http://east-bid.ybp.yahoo.com/sync/appnexuspbs?url=%s")
}
...
func newViperWithDefaults() *viper.Viper {
	...
	v.SetDefault("adapters.oath.endpoint", "http://east-bid.ybp.yahoo.com/bid/appnexuspbs")
	v.SetDefault("adapters.oath.usersync_url", "http://east-bid.ybp.yahoo.com/sync/appnexuspbs?url=%s")
	return v
}
