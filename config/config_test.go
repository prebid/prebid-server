...
func TestDefaults(t *testing.T) {
	...
	cmpInts(t, "metrics.influxdb.collection_rate_seconds", cfg.Metrics.Influxdb.CollectionRateSeconds, 20)
}
...
func TestFullConfig(t *testing.T) {
	...
	cmpInts(t, "metrics.influxdb.collection_rate_seconds", cfg.Metrics.Influxdb.CollectionRateSeconds, 30)
