...
func TestFullConfig(t *testing.T) {
	...
	cmpStrings(t, "adapters.beachfront.video_endpoint", cfg.Adapters[string(openrtb_ext.BidderBeachfront)].VideoEndpoint, "https://reachms.bfmio.com/bid.json?exchange_id")
