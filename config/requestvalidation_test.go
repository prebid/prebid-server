...
func TestParse(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			ipv6:         []string{"0101:0202::/16"},
			ipv6Expected: []net.IPNet{{IP: net.ParseIP("0101::"), Mask: ipv6Mask16}},
		},
		{
		...
		},
		{
			...
			ipv6:         []string{"0101:0202::/16", "0101:0202:0303::/32"},
			ipv6Expected: []net.IPNet{{IP: net.ParseIP("0101::"), Mask: ipv6Mask16}, {IP: net.ParseIP("0101:0202::"), Mask: ipv6Mask32}},
		},
		{
		...
		},
		{
			...
			ipv4:        []string{},
			ipv6:        []string{"0101::"},
			expectedErr: "Invalid private IPv6 network: '0101::'",
		},
		{
			description: "Malformed - IPv4 - Wrong IP Version",
			ipv4:        []string{"0101::/16"},
			ipv6:        []string{},
			expectedErr: "Invalid private IPv4 network: '0101::/16'",
		},
		{
			description: "Malformed - IPv6 - Ignore Whitespace",
			ipv4:        []string{},
