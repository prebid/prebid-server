...
type BidderInfo struct {
	...
	BaseOnly         bool         `yaml:"baseOnly" mapstructure:"baseOnly"` // if true, this bidder is only used for base requests and not for any other request types
...
func (bi BidderInfo) IsEnabled() bool {
	return !bi.BaseOnly && !bi.Disabled
}
