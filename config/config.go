...
func (cfg *Configuration) setDerivedDefaults() {
	...
	setDefaultUsersync(cfg.Adapters, openrtb_ext.BidderAdyoulike, "https://visitor.omnitagjs.com/broker/bsync?partnerId=pbsBPID&gdpr_consent_string={{.GDPRConsent}}&gdpr={{.GDPR}}")
