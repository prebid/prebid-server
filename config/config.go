...
func (cfg *Configuration) setDerivedDefaults() {
	...
	//setDefaultUsersync(cfg.Adapters, openrtb_ext.BidderOneMobile, "https://pixel.advertising.com/ups/58207/occ?"+url.QueryEscape(externalURL)+"%2Fsetuid%3Fbidder%3Donemobile%26gdpr%3D{{.GDPR}}%26gdpr_consent%3D{{.GDPRConsent}}%26uid%3D%24UID")
...
func SetupViper(v *viper.Viper, filename string) {
	...
	//v.SetDefault("adapters.onemobile.endpoint", "https://hb.nexage.com/admax/bid/partners/prebidtest")
