...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("adapters.gumgum.endpoint", "http://g2.gumgum.com/providers/prbds2s/bid")
	v.SetDefault("adapters.gumgum.usersync_url", "http://rtb.gumgum.com/usync/prbds2s?gdpr={{gdpr}}&gdpr_consent={{gdpr_consent}}&r=")
