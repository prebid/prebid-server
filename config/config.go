...
func (cfg *Configuration) setDerivedDefaults() {
	...
	setDefaultUsersync(cfg.Adapters, openrtb_ext.BidderLogan, "https://ssp-cookie.logan.ai/2b4bb0a083c436ce27a1640174020d55.gif?gdpr={{.GDPR}}&gdpr_consent={{.GDPRConsent}}&us_privacy={{.USPrivacy}}&redir="+url.QueryEscape(externalURL)+"%2Fsetuid%3Fbidder%3Dlogan%26uid%3D%5BUID%5D")
...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("adapters.logan.endpoint", "http://USeast2.logan.ai/?c=o&m=ortb")
