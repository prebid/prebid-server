...
func (cfg *Configuration) setDerivedDefaults() {
	...
	setDefaultUsersync(cfg.Adapters, openrtb_ext.BidderPlaywire, "https://x.bidswitch.net/check_uuid/"+url.QueryEscape(externalURL)+"%2Fsetuid%3Fbidder%3Dplaywire%26gdpr%3D{{.GDPR}}%26gdpr_consent%3D{{.GDPRConsent}}%26uid%3D%24%7BBSW_UUID%7D?gdpr={{.GDPR}}&gdpr_consent={{.GDPRConsent}}&us_privacy={{.USPrivacy}}")
...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("adapters.engagebdr_ortb.endpoint", "https://dsp.bnmla.com/bid?sspid=1000204")
	v.SetDefault("adapters.engagebdr_ortb.disabled", true)
	...
	v.SetDefault("adapters.gumgum_ortb.endpoint", "https://g2.gumgum.com/zones/8ylgv2wd/bid")
	v.SetDefault("adapters.gumgum_ortb.disabled", true)
	...
	v.SetDefault("adapters.pulsepoint_ortb.endpoint", "http://rts.lga.contextweb.com/rt-seller/bid/openrtb/playwire")
	v.SetDefault("adapters.pulsepoint_ortb.disabled", true)
