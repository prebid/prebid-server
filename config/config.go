...
func SetupViper(v *viper.Viper, filename string, bidderInfos BidderInfos) {
	...
	v.SetDefault("analytics.http.auction.sample_rate", 0)
	v.SetDefault("analytics.http.auction.filter", "")
	v.SetDefault("analytics.http.video.sample_rate", 0)
	v.SetDefault("analytics.http.video.filter", "")
	v.SetDefault("analytics.http.amp.sample_rate", 0)
	v.SetDefault("analytics.http.amp.filter", "")
	v.SetDefault("analytics.http.setuid.sample_rate", 0)
	v.SetDefault("analytics.http.setuid.filter", "")
	v.SetDefault("analytics.http.cookie_sync.sample_rate", 0)
	v.SetDefault("analytics.http.cookie_sync.filter", "")
	v.SetDefault("analytics.http.notification.sample_rate", 0)
