...
func (cfg *Configuration) setDerivedDefaults() {
	...
	setDefaultUsersync(cfg.Adapters, openrtb_ext.BidderAdyoulike, "https://broker.omnitagjs.com/broker/usersync?gdpr_consent_string={{.GDPRConsent}}&gdpr={{.GDPR}}")
	...
	setDefaultUsersync(cfg.Adapters, openrtb_ext.BidderAdyoulike, "https://broker.omnitagjs.com/broker/bid?Url="+url.QueryEscape(externalURL)+"&gdpr_consent_string="+{{.GDPRConsent}}+"&gdpr={{.GDPR}}&partnerId=aff110416d7293348cc15043facf8194&ad_unit=INFEED")
...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("adapters.adyoulike.endpoint", "https://broker.omnitagjs.com/broker/bid?partnerId=ba0d037e2a564951263c71c6463ee0cb&ad_unit=INFEED")
	...
	v.SetDefault("adapters.adyoulike.endpoint", "https://broker.omnitagjs.com/broker/bid")
