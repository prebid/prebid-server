...
func SetupViper(v *viper.Viper, filename string) {
	...
	// tjx adapters start
	v.SetDefault("adapters.aarki.disabled", true)
	v.SetDefault("adapters.aarki.endpoint", "https://tapjoy.aarki.net/rtb/bid")
	v.SetDefault("adapters.appier.disabled", true)
	v.SetDefault("adapters.appier.endpoint", "https://ed159.rtb.appier.net/ortb/tapjoy_use")
	...
	v.SetDefault("adapters.isx.disabled", true)
	v.SetDefault("adapters.isx.endpoint", "https://mediation-seller-prd.isprog.com/tpe")
	...
	v.SetDefault("adapters.rtbhouse.disabled", true)
...
func setBidderDefaults(v *viper.Viper, bidder string) {
	...
	v.SetDefault(adapterCfgPrefix+".xapi.endpoint_us_east", "")
	v.SetDefault(adapterCfgPrefix+".xapi.endpoint_us_west", "")
	v.SetDefault(adapterCfgPrefix+".xapi.endpoint_eu", "")
	v.SetDefault(adapterCfgPrefix+".xapi.endpoint_apac", "")
	v.SetDefault(adapterCfgPrefix+".xapi.endpoint_jp", "")
	v.SetDefault(adapterCfgPrefix+".xapi.endpoint_sg", "")
	v.SetDefault(adapterCfgPrefix+".xapi.endpoint_mature_ios", "")
	v.SetDefault(adapterCfgPrefix+".xapi.endpoint_mature_android", "")
