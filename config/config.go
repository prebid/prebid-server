...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("adapters.commerce.endpoint", "https://{{.Host}}.commerce.io/auction-engine/winning_ads")
	v.SetDefault("adapters.commerce.commerceparams.impurl", "https://{{.Host}}.commerce.io/event-collection/beacon/?action=impression")
	v.SetDefault("adapters.commerce.commerceparams.clickurl", "https://{{.Host}}.commerce.io/event-collection/beacon/?action=click")
	v.SetDefault("adapters.commerce.commerceparams.conversionurl", "https://{{.Host}}.commerce.io/event-collection/beacon/conversion")
	v.SetDefault("adapters.koddi.endpoint", "https://{{.Host}}.koddi.io/auction-engine/winning_ads")
	...
	v.SetDefault("adapters.adbuttler.endpoint", "https://{{.Host}}.adbuttler.io/auction-engine/winning_ads")
