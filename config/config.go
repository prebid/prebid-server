...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("adapters.dianomiRubiconNative.endpoint", "http://exapi-us-east.rubiconproject.com/a/api/exchange.json")
	v.SetDefault("adapters.dianomiRubiconNative.disabled", true)
