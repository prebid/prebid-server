...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("adapters.crossinstall.disabled", true)
	...
	v.SetDefault("adapters.mintegral.endpoint", "http://13.251.178.19/tapjoy_request")
	...
	v.SetDefault("adapters.tapjoy.endpoint", "https://tapjoy.com/TO_BE_DEFINED")
	...
	v.SetDefault("gdpr.tcf2.enabled", false)
