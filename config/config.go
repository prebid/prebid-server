...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("adapters.triplelift_native.endpoint", "http://localhost:8076/s2sn/auction?supplier_id=20")
	v.SetDefault("adapters.triplelift_native.extra_info", "{\"publisher_whitelist\":[\"pub-4627517680249670\"]}")
