...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("adapters.gamoshi.disabled", true)
	...
	v.SetDefault("adapters.ix.endpoint", "https://gamoshi-us-east.lb.indexww.com/pbs?p=189556")
	...
	v.BindEnv("gdpr.default_value", "0")
	v.SetDefault("gdpr.enabled", true)
	v.SetDefault("gdpr.host_vendor_id", 644)
	...
	v.SetDefault("account_required", true)
