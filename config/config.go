...
func (cfg *Configuration) setDerivedDefaults() {
	...
	setDefaultUsersync(cfg.Adapters, openrtb_ext.BidderAdxcg, "https://app.adxcg.net/cma/uid/?v=8&gdpr={{.GDPR}}&gdpr_consent={{.GDPRConsent}}&url="+url.QueryEscape(externalURL)+"%2Fsetuid%3Fbidder%3Dadxcg%26gdpr%3D{{.GDPR}}%26gdpr_consent%3D{{.GDPRConsent}}%26uid%3D%24%7Buserid%7D")
...
func SetupViper(v *viper.Viper, filename string) {
	...
	//v.SetDefault("adapters.adxcg.endpoint", "http://rtbm2mlju1.static.adxcg.net/DspOpenRtbServletPBS?adExchangeId=1")
	v.SetDefault("adapters.adxcg.endpoint", "http://rtbm2mlju1.static.mediaopti.com/DspOpenRtbServletPBS?adExchangeId=1")
