...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("adapters.s2s_gumgum.endpoint", "https://g2.gumgum.com/zones/8ylgv2wd/bid")
	...
	v.SetDefault("adapters.s2s_pulsepoint.endpoint", "http://rts.lga.contextweb.com/rt-seller/bid/openrtb/playwire")
