...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("metrics.prometheus.port", 8080)
	v.SetDefault("metrics.prometheus.namespace", "monitoring")
	v.SetDefault("metrics.prometheus.subsystem", "http_proxy")
	...
	v.SetDefault("adapters.rubicon.endpoint", "http://exapi-us-east.rubiconproject.com/a/api/exchange.json?tk_sdc=us-east")
