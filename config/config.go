...
func (cfg *Configuration) setDerivedDefaults() {
	...
	setDefaultUsersync(cfg.Adapters, openrtb_ext.BidderIQZone, "https://nep.advangelists.com/xp/user-sync?acctid={aid}&&redirect="+url.QueryEscape(externalURL)+"%2Fsetuid%3Fbidder%3Diqzone%26gdpr%3D{{.GDPR}}%26gdpr_consent%3D{{.GDPRConsent}}%26uid%3D%24UID")
...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("adapters.iqzone.endpoint", "https://nep.advangelists.com/xp/get?pubid={{.PublisherID}}")
